...
$directory = '/opt/cplearn/data/act/keys_and_scoring'; // Path to the Keys and Scoring directory
$webDirectory = '/data/act/keys_and_scoring'; // Web accessible path
...
<head>
    ...
    <title>ACT - Keys and Scoring Directory Listing</title>
    <style>
        body {
