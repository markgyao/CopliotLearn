...
<body>
    <div class="container">
        ...
        <ul>
            <?php
            $directories = [
                'bubble_sheet' => 'admin-shsat-bubble_sheet_view.php',
                'grammer' => 'admin-shsat-grammer-view.php',
                'keys_and_scoring' => 'admin-shsat-keys_and_scoring-view.php',
                'math' => 'admin-shsat-math-view.php',
                'reading' => 'admin-shsat-reading-view.php',
            ];
