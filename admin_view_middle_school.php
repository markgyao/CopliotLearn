...
<head>
    ...
    <title>Middle School Directory - Smart Club</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Middle School Directory Listing</h2>
        <ul>
            <?php
            $directories = [
                'grade_06' => 'admin_grade_06.php',
                'grade_07' => 'admin_grade_07.php',
                'grade_08' => 'admin_grade_08.php'
            ];
