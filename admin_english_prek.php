...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/prekindergarden/English'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/prekindergarden/English'; // Web accessible path
...
<head>
    ...
    <title>grade Pre-k - English Directory Listing</title>
    <style>
        body {
