...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/vocab'; // Path to the Bubble Sheets directory
$webDirectory = 'data/prek_to_12/elementary_school/vocab'; // Web accessible path
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_view_elementary_school.php" style="color:white;">Back to elementry_school</a>
        </div>
    </div>
