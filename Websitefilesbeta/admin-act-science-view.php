...
$directory = '/opt/cplearn/data/act/science'; // Path to the Science directory
$webDirectory = '/data/act/science'; // Web accessible path
...
<head>
    ...
    <title>ACT - Science Directory Listing</title>
    <style>
        body {
