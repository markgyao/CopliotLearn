...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/prekindergarden/Math'; // Path to the Math directory
$webDirectory = '/data/prek_to_12/elementary_school/prekindergarden/Math'; // Web accessible path
...
<head>
    ...
    <title>ACT - Math Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_view_act.php" style="color:white;">Back to ACT Directory</a>
        </div>
    </div>
