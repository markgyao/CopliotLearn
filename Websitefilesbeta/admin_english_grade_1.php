...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/grade_01/English'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/grade_01/Math'; // Web accessible path
...
<head>
    ...
    <title>grade 01 - Math Directory Listing</title>
    <style>
        body {
