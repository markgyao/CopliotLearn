...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/grade_04/english'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/grade_04/english'; // Web accessible path
...
<head>
    ...
    <title>grade_04 - English Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_Grade_04.php" style="color:white;">Back to Grade 04 Directory</a>
        </div>
    </div>
