...
$directory = '/opt/cplearn/data/act/writing'; // Path to the Writing directory
$webDirectory = '/data/act/writing'; // Web accessible path
...
<head>
    ...
    <title>ACT - Writing Directory Listing</title>
    <style>
        body {
