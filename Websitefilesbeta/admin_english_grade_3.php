...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/grade_03/english'; // Path to the English directory
$webDirectory = '/data/prek_to_12/elementary_school/grade_03/english'; // Web accessible path
...
// Fetch list of files and subdirectories
...
<head>
    ...
    <title>Grade 3 - English Directory Listing</title>
    <style>
    ...
    <div class="file-list-container" id="fileListContainer">
        ...
        <table>
            ...
            <?php foreach ($subdirectories as $subdirectory): ?>
                <tr>
                    <td><?php echo htmlspecialchars($subdirectory); ?></td>
                    <td class="actions">
                        <a href="admin_<?php echo htmlspecialchars($subdirectory); ?>.php">Open</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <div class="back-button">
            <a href="admin_grade_3.php" style="color:white;">Back to Grade 03 Directory</a>
        </div>
    </div>
