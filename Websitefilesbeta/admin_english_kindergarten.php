...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/kindergarten/english'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/kindergarten/english'; // Web accessible path
...
<head>
    ...
    <title>grade k - English Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_grade_01.php" style="color:white;">Back to grade 01 Directory</a>
        </div>
    </div>
