...
<head>
    ...
    <title>elementary Directory - Smart Club</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <ul>
            <?php
            $directories = [
    			'pre-kindergarten' => 'admin_prekindergarten.php',
    			'kindergarten' => 'admin_kindergarten.php',
                'grade_01' => 'admin_grade_01.php',
                'grade_02' => 'admin_grade_02.php',
                'grade_03' => 'admin_grade_03.php',
                'grade_04' => 'admin_grade_04.php',
                'grade_05' => 'admin_grade_05.php',
                'reading' => 'admin_reading.php',
                'vocab' => 'admin_vocab.php',
            ];
