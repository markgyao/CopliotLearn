...
// Editable Variables
$grade = '7'; // Set the grade here
$subject = 'math'; // Set the subject here
$directory = '/opt/cplearn/data/prek_to_12/middle_school/grade_' . $grade . '/' . $subject; // Path to the directory
$webDirectory = '/data/prek_to_12/middle_school/grade_' . $grade . '/' . $subject; // Web accessible path
...
<body>
    ...
    <script>
        ...
        // Adjust scaling based on the user's display size
        window.onload = function() {
            var width = window.innerWidth;
            var previewContainer = document.getElementById('previewContainer');

            if (width < 768) {
                // For small screens, reduce scale to fit
                previewContainer.style.transform = "scale(0.8)";
                previewContainer.style.transformOrigin = "top left";
            } else {
                // For larger screens, use full scale
