...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/grade_02/english'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/grade_02/english'; // Web accessible path
...
<head>
    ...
    <title>Grade 2 - english Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_grade_02.php" style="color:white;">Back to Grade 2 Directory</a>
        </div>
    </div>
