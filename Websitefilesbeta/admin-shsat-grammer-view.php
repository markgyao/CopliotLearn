...
$directory = '/opt/cplearn/data/act/grammar'; // Path to the Grammar directory
$webDirectory = '/data/act/grammar'; // Web accessible path
...
<head>
    ...
    <title>ACT - Grammar Directory Listing</title>
    <style>
        body {
