...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/grade_05/english'; // Path to the english directory
$webDirectory = '/data/prek_to_12/elementary_school/grade_05/english'; // Web accessible path
...
<head>
    ...
    <title>grade_05 - english Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_grade_5.php" style="color:white;">Back to grade_05 Directory</a>
        </div>
    </div>
