...
$directory = '/opt/cplearn/data/admin_important_papers'; // Path to the Important Papers directory
$webDirectory = '/data/admin_important_papers'; // Web accessible path
...
<head>
    ...
    <title>Important Papers Directory</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <table>
            ...
            <?php foreach ($files as $file): ?>
                <tr>
                    ...
                    <td class="actions">
                        <button onclick="previewFile('<?php echo htmlspecialchars($webDirectory . '/' . $file); ?>')">Preview</button>
                        <button onclick="printFile('<?php echo htmlspecialchars($webDirectory . '/' . $file); ?>')">Print</button>
        ...
        <div class="back-button">
            <a href="admin.php" style="color:white;">Back to Directory</a>
        </div>
    </div>
