...
<head>
    ...
    <title>High School Directory - Smart Club</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>High School Directory Listing</h2>
        <ul>
            <?php
            $directories = [
                'grade_10' => 'admin_grade_10.php',
                'grade_11' => 'admin_grade_11.php',
                'grade_12' => 'admin_grade_12.php'
            ];
