...
$directory = '/opt/cplearn/data/act/reading'; // Path to the Reading directory
$webDirectory = '/data/act/reading'; // Web accessible path
...
<head>
    ...
    <title>ACT - Reading Directory Listing</title>
    <style>
        body {
