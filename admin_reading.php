...
$directory = '/opt/cplearn/data/prek_to_12/elementary_school/reading'; // Path to the Bubble Sheets directory
$webDirectory = '/data/prek_to_12/elementary_school/reading'; // Web accessible path
...
<head>
    ...
    <title>ACT - Bubble Sheets Directory Listing</title>
    <style>
        body {
...
<body>
    <div class="file-list-container" id="fileListContainer">
        ...
        <div class="back-button">
            <a href="admin_view_elementary_school.php" style="color:white;">Back to Elementry School</a>
        </div>
    </div>
